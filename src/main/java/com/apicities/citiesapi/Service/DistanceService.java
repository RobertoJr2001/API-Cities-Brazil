package com.apicities.citiesapi.Service;

import com.apicities.citiesapi.Entity.City;
import com.apicities.citiesapi.Repository.CityRepository;
import com.apicities.citiesapi.Utils.StringLocationUtils;
...
public class DistanceService {
    ...
    public Double distanceByCubeInMeters(Long city1, Long city2) {
        ...
        return cityRepository.distanceByCube(((Point) p1).getX(), p1.getY(), p2.getX(), p2.getY());
    }
